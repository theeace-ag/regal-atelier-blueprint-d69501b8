              ...
              <div className="space-y-8 sticky top-32">
                ...
                <div className="border-t border-b border-muted/20 py-6 space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-serif text-foreground">THEMOON Maison</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="font-serif text-sm tracking-wider uppercase text-muted-foreground">
                      Creation Date
                    </span>
                    <span className="font-serif text-foreground">June 2025</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="font-serif text-sm tracking-wider uppercase text-muted-foreground">
                      Serial Number
                    </span>
                    <span className="font-serif text-foreground">THEMOON-LV-03</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="font-serif text-sm tracking-wider uppercase text-muted-foreground">
                      Edition Size
                    </span>
                    <span className="font-serif text-foreground">25 Pieces Worldwide</span>
                  </div>
                </div>

                <div className="space-y-4">
                  <div className="mb-6">
                    <span className="font-serif text-xs tracking-widest uppercase text-accent">Launch Status</span>
                    <p className="font-serif text-muted-foreground mt-2">Coming Soon — By Invitation</p>
                  </div>
                  <p className="font-serif text-xs text-muted-foreground text-center">
                    Each piece includes signed provenance certificate and full documentation
                  </p>
                </div>
                ...
                <div className="bg-card p-6 border border-muted/20">
                  ...
                  <ul className="space-y-2 text-sm text-card-foreground font-serif">
                    <li>• Professional dry clean only</li>
                    <li>• Store in provided garment case</li>
                    <li>• Avoid direct sunlight exposure</li>
                    <li>• Full provenance documentation included</li>
                    <li>• Authentication available through THEMOON</li>
                  </ul>
                </div>
              </div>
            </div>
